...
// CREDITS: "github.com/marpaia/graphite-golang"
...
// Connect Given a Graphite struct, Connect populates the Graphite.conn field with an
...
// Disconnect Given a Graphite struct, Disconnect closes the Graphite.conn field
...
// SendMetric Given a Metric struct, the SendMetric method sends the supplied metric to the
...
// SendMetrics Given a slice of Metrics, the SendMetrics method sends the metrics, as a
...
// NewGraphiteUDP When a UDP connection to Graphite is required
